...
<div class="content-wrapper"> 
  ...
  <section class="content-header">
    <h1>  List All In Progress Complaint </h1>
    <ol class="breadcrumb">
            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <?php if(isset($multiListingData)) foreach($multiListingData as $row){?>
                <tr>
                  ...
                  <a onclick="return confirm('Are you sure you want to delete this?');" href="main/web_comp/idelete/<?=$row->c_id?>" class="btn" style="background-color:#d73925; color: #fff;"><i class="fa fa-fw fa-close"></i></a>
                   <?php }?>
                    <a href="main/web_comp/iedit/<?=$row->c_id?>" class="btn" style="background-color: #222d32;color: #fff; "><i class="fa fa-fw fa-edit"></i></a>
