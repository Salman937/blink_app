        ...
        <div class="box"> 
          ...
          <div class="box-body">
            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
              <?php if(isset($head_districts)) foreach($head_districts as $head_district){?>
                <tr>
                  <td><?=$head_district->id?></td>
                  <td><?=$head_district->districts_categories?></td>
                  <td>
                  <a href="<?= base_url() ?>Districts/edit_district/<?= $head_district->id ?>">
                  ...
                  <a href="<?= base_url() ?>Districts/delete_district/<?= $head_district->id ?>">
