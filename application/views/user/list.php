                  ...
                  <script type="text/javascript">ga('send', 'event', 'select', 'Click', 'status');</script>
                   <?php if($row->status == 'pendingreview'){?>
                    ...
                    <select class="" name="status">
                      ...
                      <option value="pendingreview" <?php if($row->status=='pendingreview')echo 'selected';?>>Pending Review</option>
                     <option value="underreview" <?php if($row->status=='underreview')echo 'selected';?>>Under Review</option>
