...
<div class="content-wrapper"> 
  ...
  <section class="content-header">
    <h1> List All Pending Complaint </h1>
    <ol class="breadcrumb">
            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <?php if(isset($multiListingData)) foreach($multiListingData as $row){?>
                <tr>
                  ...
                  <td><?php $data = $this->session->all_userdata();
                  if($data['mobilenumber'] == "03358018012") {?><a onclick="return confirm('Are you sure you want to delete this?');" href="main/web_comp/pdelete/<?=$row->c_id?>" class="btn" style="background-color:#d73925; color: #fff;"><i class="fa fa-fw fa-close"></i></a>
                  <?php }?>

                    <a href="main/web_comp/pedit/<?=$row->c_id?>" class="btn" style="background-color: #222d32;color: #fff; "><i class="fa fa-fw fa-edit"></i></a></td>
                </tr>
                <?php }?>
              </tbody>
              <tfoot>
